    ...
    return (
        <>
            ...
            <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
                Import icons by their PascalCase name from <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">@vezham/icons-react-native</code>. Each icon is a React Native component that works with react-native-svg.
            </p>

            <SyntaxBlock
                title="JSX"
                onCopy={() => onCopy("import { View } from 'react-native';\nimport { Home, ShieldCheck, Bell } from '@vezham/icons-react-native';\n\nfunction App() {\n  return (\n    <View>\n      <Home size={24} />\n      <ShieldCheck size={24} color=\"#6C5CE7\" />\n      <Bell size={24} weight=\"filled\" />\n    </View>\n  );\n}", 'rn-basic')}
            ...
            >
                ...
                <span className="text-text-base/70">{' } '}</span>
                <span className="text-[#c678dd]">from</span>
                <span className="text-[#98c379]"> '@vezham/icons-react-native'</span>
                <span className="text-text-base/30">;</span>
                {'\n\n'}
            ...
            <SyntaxBlock
                title="Direct Import"
                onCopy={() => onCopy("import Home from '@vezham/icons-react-native/icons/Home';\nimport ShieldCheck from '@vezham/icons-react-native/icons/ShieldCheck';", 'rn-direct')}
                copied={copiedField === 'rn-direct'}
            >
                <span className="text-[#c678dd]">import</span><span className="text-[#e5c07b]"> Home</span><span className="text-[#c678dd]"> from</span><span className="text-[#98c379]"> '@vezham/icons-react-native/icons/Home'</span><span className="text-text-base/30">;</span>
                {'\n'}
                <span className="text-[#c678dd]">import</span><span className="text-[#e5c07b]"> ShieldCheck</span><span className="text-[#c678dd]"> from</span><span className="text-[#98c379]"> '@vezham/icons-react-native/icons/ShieldCheck'</span><span className="text-text-base/30">;</span>
            </SyntaxBlock>
        </>
    );
}
