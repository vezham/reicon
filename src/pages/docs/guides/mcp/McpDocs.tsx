  ...
  return (
    <section id="mcp" data-section className="mb-16 scroll-mt-24">
      ...
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-6">
        The <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">vezham-icons-mcp</code> package exposes Vezham icons to AI agents through the{' '}
