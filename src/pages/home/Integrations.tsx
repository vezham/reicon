        ...
        <section id="integrations" className="reveal max-w-[1160px] mx-auto px-5 md:px-10 py-13">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[14px]">
                ...
                <IntegrationCard
                    ...
                    copyText={`import 'package:vezham_icons/icons.dart';\n\nfinal home = Vezham.outline.home;\nvezhamIconSvg(home, size: 24);`}
                    lines={<>
                        <div className="mb-2">
                            <span className="text-[#ffbd2e]">$</span>
                            <span className="text-[#e06c75]"> flutter</span>
                            <span className="text-text-base/70"> pub add vezham_icons</span>
                        </div>
                        <div>
                            <span className="text-[#c678dd]">import</span>
                            <span className="text-text-base/70"> 'package:vezham_icons/icons.dart';</span>
                        </div>
                        <div className="mt-3">
