...
* They parse raw SVGs, strip header boilerplate, normalize legacy hardcoded colors to `currentColor`, and wrap them in template wrappers specific to each framework.
