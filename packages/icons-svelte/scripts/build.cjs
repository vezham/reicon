#!/usr/bin/env node
/**
 * build.cjs — Generates the `@vezham/icons-svelte` Svelte package from data/icons
 *
...
<!--
  @component
  @name ${icon.pascal}
  @description Vezham Svelte icon component, renders an SVG Element.
...
const pkg = {
  ...
  type: 'module',
  description:
    `Svelte icon components for ${icons.length}+ icons in 4 weights. Tree-shakeable, TypeScript-ready.`,
  main: './index.js',
  module: './index.js',
  svelte: './index.js',
  types: './index.d.ts',
...
<p align="center">
  <b>${icons.length}+ pixel-perfect SVG icons</b> • outline, filled, duotone-outline, and duotone-filled weights • Svelte component wrapper • Zero dependencies • MIT Licensed
</p>
...
**Vezham Svelte** is the official Svelte package for <a href="https://vezham.com">Vezham</a> — a free, open-source SVG icon library featuring ${icons.length}+ handcrafted, grid-aligned icons. Every component is tree-shakeable, fully TypeScript-ready, and ships with zero dependencies.
...
| [\`@vezham/icons-svelte\`](https://npmjs.com/package/@vezham/icons-svelte) | **You are here.** Svelte components for ${icons.length}+ icons. |
