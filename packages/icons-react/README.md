...
**Reicon React** is the official React package for <a href="https://reicon.dev">Reicon</a> — a free, open-source SVG icon library featuring 2679+ handcrafted, grid-aligned icons. Every component is tree-shakeable, fully TypeScript-ready, and ships with zero dependencies.
...
| [`reicon-react`](https://npmjs.com/package/reicon-react) | **You are here.** React components for 2679+ icons. |
