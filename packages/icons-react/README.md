...
**Vezham React** is the official React package for <a href="https://vezham.com">Vezham</a> — a free, open-source SVG icon library featuring 1273+ handcrafted, grid-aligned icons. Every component is tree-shakeable, fully TypeScript-ready, and ships with zero dependencies.
...
| [`@vezham/icons-react`](https://npmjs.com/package/@vezham/icons-react) | **You are here.** React components for 1273+ icons. |
